...
export const metadata: Metadata = {
  ...
  keywords: ['web3 marketing', 'software marketing', 'blockchain', 'DeFi', 'crypto growth', 'portfolio'],
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${syne.variable} ${spaceMono.variable} bg-background`}>
